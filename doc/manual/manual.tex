...
\begin{itemize}
\item ne     = NE !the number of elements
\item max\_ns = NS !the maximum number of species
\item Ru         = 8.3144621d0 !universal gas constant
\item pst        = 1d5         !standard state pressure
\item omega      = 0.5d0       !relaxation factor
\item eps        = 1d-9        !epsilon for convergence
\item initial\_eps= 1d-5        !epsilon to stabilize calculation
\item Y\_eps      = 1d-6        !epsilon for reduction determination
\item TSIZE      = 1d-11       !epsilon for calc E or H
\item TTSIZE     = 1d-14       !epsilon for calc n
\item ns
\item nt
\end{itemize}
test
