...
subroutine set_TGv!{{{
   ...
   double precision,dimension(nV)::dYvdxi,dYvdeta,dYvdx,dYvdr
   ...
   do plane=nps,npe
      ...
      do j=nys(plane),nye(plane)
         do i=nxs(plane)-1,nxe(plane)
            ...
            do k=1,nV
               dwdeta(k)   =  (Yv(k,i+1,j+1,plane) +Yv(k,i,j+1,plane)&
