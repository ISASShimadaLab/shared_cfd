   ...
   do plane = nps,npe
      ...
      do j=nys(plane),nye(plane)
         do i=nxs(plane),nxe(plane)
            ...
            Dq(:,i,j,plane)=Dq(:,i,j,plane)+pre_sca(2,i,j,plane)*dot_product(pre2(:,i,j,plane),Dq(:,i,j,plane))*pre1(:,i,j,plane)
         end do
      end do
      !$omp end parallel do
      ...
      do sm=nxs(plane)+nys(plane),nxe(plane)+nye(plane)
         ...
         do i=max(nxs(plane),sm-nye(plane)),min(sm-nys(plane),nxe(plane))
            ...
            Dq(:,i,j,plane)=Dq(:,i,j,plane)+pre_sca(4,i,j,plane) *dot_product(pre2(:,i,j,plane),Dq(:,i,j,plane)) *pre1(:,i,j,plane)
      ...
      do j=nys(plane),nye(plane)
         do i=nxs(plane),nxe(plane)
            Dq(:,i,j,plane)=Dq(:,i,j,plane)+pre_sca(3,i,j,plane) *dot_product(pre2(:,i,j,plane),Dq(:,i,j,plane)) *pre1(:,i,j,plane)
